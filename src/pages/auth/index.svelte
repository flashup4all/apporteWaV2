...
import { store_token, store_user, get_token } from '../../localstore'
              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="email" class="form-control" bind:value={auth_form.email} placeholder="email" autocomplete="email"  required>
                  </div>
